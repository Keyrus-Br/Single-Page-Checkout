...
import br.com.keyrus.constants.B2csinglepagecheckoutaddonConstants;



/**
 * This is the extension manager of the B2csinglepagecheckoutaddon extension.
 */
public class B2csinglepagecheckoutaddonManager extends GeneratedB2csinglepagecheckoutaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2csinglepagecheckoutaddonManager.class.getName());
	 ...
	 */
	public static B2csinglepagecheckoutaddonManager getInstance()
	{
		return (B2csinglepagecheckoutaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				B2csinglepagecheckoutaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2csinglepagecheckoutaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2csinglepagecheckoutaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2csinglepagecheckoutaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2csinglepagecheckoutaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
