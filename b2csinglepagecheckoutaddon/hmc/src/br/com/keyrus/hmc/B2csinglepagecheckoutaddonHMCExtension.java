...
/**
 * Provides necessary meta information about the b2csinglepagecheckoutaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.6.0.0-SNAPSHOT
 */
public class B2csinglepagecheckoutaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(B2csinglepagecheckoutaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "br.com.keyrus.hmc.locales";
